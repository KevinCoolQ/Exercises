...
namespace SportsStore
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            PrintCustomers("Klanten die reeds een Football bestelden: ", customersWithFootball);
            Console.ReadLine();
            #endregion
            ...
            try
            {
                var customer = customers.SingleOrDefault(c => c.Name.Equals(naam)); // FirstOrDefault() geeft nooit een exception
                if (customer == null)
